            ...
            <Row>
                ...
                <Col sm="12">
                    <Card title="Dark" code={tableDark} noBody>
                        <CardBody>
                            <CardText>
                                Use prop <code>dark</code> to create a dark
                                inverted table.
                            </CardText>
                        </CardBody>
                        <TableDark />
                ...
                <Col sm="12">
                    <Card
                        ...
                        code={tableTheadOptions}
                        noBody
                    >
                        <CardBody>
                            <CardText>
                                Similar to tables and dark tables, use the
                                modifier classes <code>.table-dark</code> to
                                make <code>&lt;thead&gt;</code> appear dark.
                            </CardText>
                        </CardBody>
                        <TableTheadDark />
                        <CardBody className="mt-2">
                            <p className="m-0">
                                Use the modifier class <code>.table-light</code>{' '}
                                to make <code>&lt;thead&gt;</code> appear light.
                            </p>
                        </CardBody>
                        <TableTheadLight />
                    </Card>
                ...
                <Col sm="12">
                    <Card title="Striped" code={tableStriped} noBody>
                        <CardBody>
                            <CardText>
                                Use prop <code>striped</code> to create a
                                striped table.
                            </CardText>
                        </CardBody>
                        <TableStriped />
                ...
                <Col sm="12">
                    <Card title="Striped Dark" code={tableStripedDark} noBody>
                        <CardBody>
                            <CardText>
                                Use props <code>striped</code> &{' '}
                                <code>dark</code> to create a dark striped
                                table.
                            </CardText>
                        </CardBody>
                        <TableStripedDark />
                ...
                <Col sm="12">
                    <Card title="Bordered" code={tableBordered} noBody>
                        <CardBody>
                            <CardText>
                                Use prop <code>bordered</code> to create a
                                bordered table.
                            </CardText>
                        </CardBody>
                        <TableBordered />
                ...
                <Col sm="12">
                    <Card title="Borderless" code={tableBorderless} noBody>
                        <CardBody>
                            <CardText>
                                Use prop <code>borderless</code> to create a
                                borderless table.
                            </CardText>
                        </CardBody>
                        <TableBorderless />
                ...
                <Col sm="12">
                    <Card title="Hoverable" code={tableHover} noBody>
                        <CardBody>
                            <CardText>
                                Use prop <code>hover</code> to create a
                                hoverable table.
                            </CardText>
                        </CardBody>
                        <TableHover />
                ...
                <Col sm="12">
                    <Card title="Small" code={tableSmall} noBody>
                        <CardBody>
                            <CardText>
                                Use prop <code>size="sm"</code> to create a
                                small table.
                            </CardText>
                        </CardBody>
                        <TableSmall />
                ...
                <Col sm="12">
                    <Card title="Responsive" code={tableResponsive} noBody>
                        <CardBody>
                            <CardText>
                                Use prop <code>responsive</code> to make your
                                table responsive.
                            </CardText>
                        </CardBody>
                        <TableResponsive />
