            ...
            <Row className="text-center">
                <Col className="mb-4 mb-md-0" md="4" xs="12">
                    <div className="w-75 mx-auto">
                        ...
                        <CardText>
                            Chocolate bar candy canes ice cream toffee.
                            Croissant pie cookie halvah.
                        </CardText>
                    </div>
                </Col>
                <Col className="mb-4 mb-md-0" md="4" xs="12">
                    <div className="w-75 mx-auto">
                        ...
                        <CardText>
                            Marshmallow biscuit donut dragée fruitcake. Jujubes
                            wafer cupcake.
                        </CardText>
                    </div>
                </Col>
                <Col className="mb-4 mb-md-0" md="4" xs="12">
                    <div className="w-75 mx-auto">
                        ...
                        <CardText>
                            Cotton candy gingerbread cake I love sugar plum I
                            love sweet croissant.
                        </CardText>
                    </div>
                </Col>
            </Row>
