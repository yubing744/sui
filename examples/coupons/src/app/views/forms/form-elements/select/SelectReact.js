...
const SelectReact = () => {
    return (
        <Card>
            ...
            <CardBody>
                <p>
                    React Select is a flexible and beautiful Select Input
                    control for ReactJS with multiselect, autocomplete, async
                    and creatable support. You can read it's documentation from{' '}
                    <a
                        className="my-50"
                        target="_blank"
