            ...
            <CardBody>
                <Row className="pb-50">
                    ...
                    >
                        <div className="session-info mb-1 mb-lg-0">
                            <h2 className="fw-bold mb-25">
                                {kFormatter(data.sessions)}
                            </h2>
                            <CardText className="fw-bold mb-2">
                                Avg claimed coupons per day
                            </CardText>
                            <h5 className="font-medium-2">
                                <span className="text-success me-50">
                                    {data.growth}
                                </span>
                ...
                <Row className="pt-50">
                    <Col className="mb-2" md="6" sm="12">
                        <p className="mb-50">
                            Avg claimed coupons goal: {kFormatter(data.goal)}
                        </p>
                        <Progress
                    ...
                    <Col className="mb-2" md="6" sm="12">
                        <p className="mb-50">Users: {data.users}</p>
                        <Progress
                    ...
                    <Col md="6" sm="12">
                        <p className="mb-50">Avg discount: {data.discount}%</p>
                        <Progress
