                            ...
                            <Table responsive bordered>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            Refresh your card content using
                                            refresh action.
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td>
                                            {' '}
                                            Remove card from page using remove
                                            card action
                                        </td>
                                    </tr>
                                </tbody>
            ...
            <Row>
                <Col md="6" sm="12">
                    <CardAction title="Collapse" actions="collapse">
                        <CardBody className="pt-0">
                            <CardText>
                                You can create a collapsible content by using
                                our <code>CardAction</code> component and by
                                passing prop <code>actions='collapse'</code>.
                            </CardText>
                            <CardText className="mb-0">
                                Click on <ChevronDown size={15} /> to see card
                                collapse in action
                            </CardText>
                        </CardBody>
                    </CardAction>
                ...
                <Col md="6" sm="12">
                    ...
                    >
                        <CardBody className="pt-0">
                            ...
                            <CardText className="mb-0">
                                Click on <RotateCw size={15} /> to see card
                                refresh in action
                            </CardText>
                        </CardBody>
                    </CardAction>
                ...
                <Col md="6" sm="12">
                    <CardAction title="Remove" actions="remove">
                        <CardBody className="pt-0">
                            <CardText>
                                You can add refresh content action to card by
                                adding class <code>.card-reload</code> with your
                                card tag, and add conditional spinner into card
