                ...
                <Col sm="12">
                    <section id="component-breadcrumbs">
                        ...
                        <Card title="Styles" code={breadcrumbsStyles}>
                            <CardText>
                                These breadcrumbs are only for demo puropses.
                                You can change breadcrumb seprator by changing{' '}
                                <code>$breadcrumb-divider</code> variable value
                                in scss
                            </CardText>
                            <BreadCrumbStyles />
                        </Card>
                ...
                <Col sm="12">
                    <section id="breadcrumb-alignment">
                        <Card title="Alignment" code={breadcrumbsAlignment}>
                            <CardText>
                                Use class{' '}
                                <code>.justify-content-{'{position}'}</code> to
                                align breadcrumb to desired position.
                            </CardText>
                            <BreadCrumbAlignment />
                        </Card>
                    </section>
