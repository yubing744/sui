            ...
            <Row>
                <Col sm="12">
                    <Card title="Contextual" code={badgePillContextual}>
                        <CardText className="mb-0">
                            Use prop <code>pill</code> with <code>Badge</code>{' '}
                            tag to create badge pill.
                        </CardText>
                        <BadgePillContextual />
                    </Card>
                </Col>
                <Col sm="12">
                    <Card title="Glow" code={badgePillGlow}>
                        <CardText className="mb-0">
                            Use class <code>.badge-glow</code> with{' '}
                            <code>Badge</code> tag to add glow effect to your
                            badge.
                        </CardText>
                        <BadgeGlow />
                    </Card>
                ...
                <Col sm="12">
                    <Card title="Light" code={badgePillLight}>
                        <CardText className="mb-0">
                            ...
                            <code>color="light-COLOR_NAME"</code> with{' '}
                ...
                <Col sm="12">
                    <Card title="Notifications" code={badgePillNotification}>
                        <CardText className="mb-0">
                            Use <code>.badge-up</code> to set pill badge to
                            higher than other text. So that it can work with
                            notifications also.
                        </CardText>
                        <BadgeNotification />
                    </Card>
            ...
            <Row className="match-height">
                <Col md="6" sm="12">
                    <Card title="Link" code={badgePillLink}>
                        <CardText>
                            Use <code>href="#"</code> prop to use badge as a
                            link.
                        </CardText>
                        <BadgePillLink />
                    </Card>
                ...
                <Col md="6" sm="12">
                    <Card title="Block" code={badgePillBlock}>
                        <CardText>
                            Use <code>.d-block</code> class to make badge
                            display as block.
                        </CardText>
                        <BadgePillBlock />
                    </Card>
