            ...
            <Row>
                <Col sm="12">
                    <Card title="Uncontrolled" code={accordionControlled}>
                        <CardText>
                            You may want to open one item at a time, for that
                ...
                <Col sm="12">
                    <Card
                        code={accordionWithoutArrow}
                        title="Accordion Without Arrow"
                    >
                        <CardText>
                            Use class <code>.accordion-without-arrow</code>{' '}
                            class with <code>&lt;Accordion&gt;</code> for
                ...
                <Col sm="12">
                    <Card title="Border" code={accordionBorder}>
                        <CardText>
                            ...
                            your accordion to create a bordered accordion.
                        </CardText>
                        <AccordionBorder />
                    </Card>
                </Col>
                <Col sm="12">
                    <Card title="Margin" code={accordionMargin}>
                        <CardText>
                            Use class <code>.accordion-margin</code> class with
                            your accordion to create a accordion with margin.
                        </CardText>
                        <AccordionMargin />
                    </Card>
                </Col>
