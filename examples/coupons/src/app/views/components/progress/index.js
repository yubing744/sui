...
const Progress = () => {
    ...
    return (
        <Fragment>
            <BreadCrumbs
                title="Progress"
                data={[{ title: 'Components' }, { title: 'Progress' }]}
            />
            <Row>
                <Col lg="12">
                ...
                <Col lg="12">
                    <Card title="Colored Progress" code={progressColored}>
                        <CardText>
                            Use <code>progress-bar-[color]</code> class with
                            progress to change progress color.
                        </CardText>
                        <ProgressColored />
                    </Card>
                </Col>
                <Col lg="12">
                    <Card title="Labeled Progress" code={progressLabeled}>
                        <CardText>
                            Add text between progress tag to create a labeled
                            progress bar.
                        </CardText>
                        <ProgressLabeled />
                    </Card>
                ...
                <Col lg="12">
                    <Card
                        ...
                        code={progressMultipleStacked}
                    >
                        <CardText>
                            To create a multi colored progress wrap all of your
                            progresses in with <code>multi</code> prop.
                        </CardText>
                        <ProgressMultipleStacked />
                    </Card>
                </Col>
                <Col lg="12">
                    <Card title="Striped Progress" code={progressStriped}>
                        <CardText>
                            Use <code>striped</code> prop with progress to
                ...
                <Col lg="12">
                    <Card title="Animated Progress" code={progressAnimated}>
                        <CardText>
                            Use <code>animated</code> prop with progress to
