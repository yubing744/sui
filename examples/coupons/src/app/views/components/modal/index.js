...
const Modals = () => {
    ...
    return (
        <Fragment>
            <BreadCrumbs
                title="Modal"
                data={[{ title: 'Components' }, { title: 'Modal' }]}
            />
            <Row>
                <Col sm="12">
                    <Card title="Modal Basic" code={modalBasic}>
                        <CardText className="mb-0">
                            ...
                            <code>ModalFooter</code> tags to create a Modal with
                            reactstrap.
                        </CardText>
                        <ModalBasic />
                    </Card>
            ...
            <Row>
                ...
                <Col sm="12">
                    <Card title="Modal Events" code={modalEvents}>
                        <CardText className="mb-0">
                            Use props <code>onClosed / onOpened</code> for modal
                            events.
                        </CardText>
                        <ModalEvents />
                    </Card>
            ...
            <Row>
                ...
                <Col sm="12">
                    <Card title="Unmount On Close" code={modalUnmount}>
                        <CardText>
                            Write something (data should remain in modal if
                            unmountOnClose is set to false).
                        </CardText>
                        <ModalUnmount />
                    </Card>
                </Col>
