...
const NavComponent = () => {
    ...
    return (
        <Fragment>
            <BreadCrumbs
                title="Navs"
                data={[{ title: 'Components' }, { title: 'Navs' }]}
            />
            <Row className="match-height">
                <Col md="6" sm="12">
                    <Card title="Base Nav" code={navBasic}>
                        <CardText>
                            The base nav component provides a strong foundation
                ...
                <Col md="6" sm="12">
                    <Card title="Center Alignment" code={navCenter}>
                        <CardText>
                            Use Class <code>.justify-content-center</code> with
                            your <code>nav</code> tag to align your nav to
                            center.
                        </CardText>
                        <NavCenter />
                    </Card>
                ...
                <Col md="6" sm="12">
                    <Card title="End Alignment" code={navEnd}>
                        <CardText>
                            Use Class <code>.justify-content-end</code> with
                            your <code>nav</code> tag to align your nav to End.
                        </CardText>
                        <NavEnd />
                    </Card>
                </Col>
                <Col md="6" sm="12">
                    <Card title="Vertical Nav" code={navVertical}>
                        <CardText>
                            Use prop <code>vertical</code> with nav tag to make
                            it vertical.
                        </CardText>
                        <NavVertical />
                    </Card>
                ...
                <Col md="6" sm="12">
                    <Card
                        title="Vertical Nav With Border"
                        code={navVerticalBorder}
                    >
                        <CardText>
                            To wrap with border, use{' '}
                            <code>.wrap-border class</code>.
                        </CardText>
                        <NavVerticalBorder />
                    </Card>
                </Col>
                <Col md="6" sm="12">
                    <Card title="Nav With square Border" code={navSquareBorder}>
                        <CardText>
                            To wrap with square border, use{' '}
                            <code>.square-border</code> class with{' '}
                ...
                <Col md="6" sm="12">
                    <Card title="Nav With Divider" code={navDivider}>
                        <CardText>
                            To add divider, use <code>.dropdown-divider</code>{' '}
                            class to <code>NavItem</code>
                        </CardText>
                        <NavDivider />
                    </Card>
                </Col>
