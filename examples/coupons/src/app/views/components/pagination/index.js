...
const Pagination = () => {
    ...
    return (
        <Fragment>
            <BreadCrumbs
                title="Pagination"
                data={[{ title: 'Components' }, { title: 'Pagination' }]}
            />
            <Row className="match-height">
                ...
                <Col md="6" sm="12">
                    <Card
                        title="Separated Pagination"
                        code={paginationSeparated}
                    >
                        <CardText>
            ...
            <Row>
                <Col sm="12">
                    <Card title="Positions" code={paginationPositions}>
                        <CardText>
                            Use classes{' '}
                            <code>.justify-content-[direction]</code> with{' '}
                            <code>pagination</code> tag.
                        </CardText>
                        <PaginationPositions />
                    </Card>
                ...
                <Col sm="12">
                    <Card title="Sizes" code={paginationSizes}>
                        <CardText>
                            Use prop <code>size="lg"</code> for large size
                            pagination & use <code>size="sm"</code>
