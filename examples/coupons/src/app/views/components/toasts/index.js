...
const Toasts = () => {
    ...
    return (
        <Fragment>
            <BreadCrumbs
                title="Toasts"
                data={[{ title: 'Components' }, { title: 'Toasts' }]}
            />
            <Row className="match-height">
                <Col sm="12">
                    <Card title="Toast Translucent" code={toastTranslucent}>
                        <CardText>
                            ...
                            that support the backdrop-filter CSS property, we’ll
                ...
                <Col sm="12">
                    <Card title="Icons" code={toastHeaderIcons}>
                        <CardText>
                            Use <code>icon</code> attribute with{' '}
                            <code>ToastHeader</code> tag to add an icon.
                        </CardText>
                        <ToastHeaderIcons />
                    </Card>
                </Col>
