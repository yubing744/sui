...
const Carousel = () => {
    ...
    return (
        <Fragment>
            <BreadCrumbs
                title="Carousel"
                data={[{ title: 'Components' }, { title: 'Carousel' }]}
            />
            <Row>
                ...
                <Col md="6" sm="12">
                    <Card
                        ...
                        code={carouselUncontrolled}
                    >
                        <CardText>
                            You don't have to manage state with{' '}
                            <code>UncontrolledCarousel</code> all you have to do
                            is return it with your content.
                        </CardText>
                        <CarouselUncontrolled />
                    </Card>
                </Col>
                <Col md="6" sm="12">
                    <Card title="Interval Example" code={carouselInterval}>
                        <CardText>
                            Use <code>Interval</code> prop to set interval
                            between slides. default interval is{' '}
                            <strong>5000</strong>.
                        </CardText>
                        <CarouselInterval />
                    </Card>
                ...
                <Col md="6" sm="12">
                    <Card title="Keyboard Example" code={carouselKeyboard}>
                        <CardText>
                            Use <code>Keyboard</code> prop to control carousel
                            with keyboard default is <code>false</code>.
                        </CardText>
                        <CarouselKeyboard />
                    </Card>
                </Col>
                <Col md="6" sm="12">
                    <Card title="Pause Example" code={carouselPause}>
                        <CardText>
                            Use <code>pause</code> prop to pause carousel on
                            hover.
                        </CardText>
                        <CarouselPause />
                    </Card>
