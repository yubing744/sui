            ...
            <Row>
                <Col xl="6" lg="12">
                    <Card title="Controlled Tooltip" code={tooltipControlled}>
                        <CardText>
                            For controlled tooltips you'll have to manage state
                            of component.controlled tooltips require{' '}
                ...
                <Col xl="6" lg="12">
                    ...
                    >
                        <CardText>
                            ...
                            <code>isOpen</code> nor <code>toggle</code> props to
                            work.All you have to do is provide a valid target to
                            tooltip.
                        </CardText>
                        <TooltipUncontrolled />
                    </Card>
                ...
                <Col sm="12">
                    <Card title="Tooltip Positions" code={tooltipPosition}>
                        <CardText className="mb-0">
                            Use prop <code>placement</code> to change position
                            of tooltip.
                        </CardText>
                        <TooltipPositions />
                    </Card>
