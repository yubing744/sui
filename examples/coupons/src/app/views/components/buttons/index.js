            ...
            <Row>
                <Col sm="12">
                    <Card title="Filled" code={filledButtons}>
                        <CardText className="mb-0">
                            Reactstrap includes six predefined button styles,
                ...
                <Col sm="12">
                    <Card title="Outline" code={outlineButtons}>
                        <CardText className="mb-0">
                            Use prop <code>outline</code> with button tag to
                ...
                <Col sm="12">
                    <Card title="Flat" code={flatButtons}>
                        <CardText className="mb-0">
                            Use <code>color="flat-{'colorName'}"</code> to
                ...
                <Col sm="12">
                    <Card title="Gradient" code={gradientButtons}>
                        <CardText className="mb-0">
                            Use <code>color="gradient-{'colorName'}"</code> to
                ...
                <Col sm="12">
                    <Card title="Relief" code={reliefButtons}>
                        <CardText className="mb-0">
                            Use <code>color=relief-{'colorName'}</code> to
                            create a relief button.
                        </CardText>
                        <ReliefButtons />
                    </Card>
                </Col>
                <Col sm="12">
                    <Card title="Round" code={roundButtons}>
                        <CardText className="mb-0">
                            Use class <code>.round</code> create a square
                            button.
                        </CardText>
                        <RoundButtons />
                    </Card>
                ...
                <Col sm="12">
                    <Card title="Icon Only" code={iconOnlyButtons}>
                        <CardText className="mb-0">
                            You can use class <code>.btn-icon</code>. You can
                            create a rounded button by using{' '}
                            <code>.rounded-circle</code> with{' '}
                            <code>.btn-icon</code>. You can only use{' '}
                            <code>.btn-icon</code> when you only want icon in
                            your button
                        </CardText>
                        <IconOnlyButtons />
                    </Card>
                ...
                <Col sm="12">
                    <Card title="Sizes" code={buttonSizes}>
                        <CardText className="mb-0">
                            Use <code>size</code> prop to change size of a
                            button.
                        </CardText>
                        <ButtonSizes />
                    </Card>
                ...
                <Col sm="12">
                    <Card title="Block Level Buttons" code={buttonBlock}>
                        <CardText>
                            Create block level buttons with a mix of our display
                            and gap utilities or by using prop{' '}
                            <code>block</code>.
                        </CardText>
                        <ButtonBlock />
                    </Card>
