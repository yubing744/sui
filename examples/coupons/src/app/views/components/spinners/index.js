...
const Spinners = () => {
    ...
    return (
        <Fragment>
            <BreadCrumbs
                title="Spinners"
                data={[{ title: 'Components' }, { title: 'Spinners' }]}
            />
            <Row className="match-height">
                <Col md="6" sm="12">
                    <Card title="Border Spinner" code={spinnerBorder}>
                        <CardText>
                            Use <code>Spinner</code> tag to create a bordered
                            spinner.
                        </CardText>
                        <SpinnerBorder />
                    </Card>
                ...
                <Col md="6" sm="12">
                    <Card title="Colors" code={spinnerColors}>
                        <CardText className="mb-0">
                            Use <code>color</code> attribute to create a colored
                            spinner.
                        </CardText>
                        <SpinnerColors />
                    </Card>
                ...
                <Col md="6" sm="12">
                    <Card title="Growing Spinner" code={spinnerGrowing}>
                        <CardText>
                            Use <code>type="grow"</code> with spinner tag to
                ...
                <Col md="6" sm="12">
                    <Card
                        ...
                        code={spinnerGrowColors}
                    >
                        <CardText className="mb-0">
                            Use <code>color</code> and <code>type</code>{' '}
                            attribute to create a colored growing spinner.
                        </CardText>
                        <SpinnerGrowColors />
                    </Card>
                </Col>
                ...
                <Col md="6" sm="12">
                    <Card title="Float" code={spinnerFloat}>
                        <CardText>
                            Use <code>.float-[side]</code> with spinner tag to
                            change spinner's position.
                        </CardText>
                        <SpinnerFloat />
                    </Card>
                </Col>
                <Col md="6" sm="12">
                    <Card title="Text Alignment" code={spinnerTextAlignment}>
                        <CardText>
                            You can also use <code>.text-[side]</code> as a
                            wrapper to spinner tag to change spinner's position.
                        </CardText>
                        <SpinnerTextAlignment />
                    </Card>
                </Col>
                <Col md="6" sm="12">
                    <Card title="Sizes" code={spinnerSizes}>
                        <CardText className="mb-0">
                            Use prop <code>size="sm"</code> for Small spinner or
                            use <code>style</code> prop for custom size.
                        </CardText>
                        <SpinnerSizes />
                    </Card>
                </Col>
