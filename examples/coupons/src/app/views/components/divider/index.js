...
const Divider = () => {
    ...
    return (
        <Fragment>
            <BreadCrumbs
                title="Divider"
                data={[{ title: 'Components' }, { title: 'Divider' }]}
            />
            <Row>
                <Col sm="12">
                ...
                <Col sm="12">
                    <Card title="Position" code={dividerPosition}>
                        <CardText>
                            Use class{' '}
                            <code>
                                .divider-[start | start-center | end |
                                end-center]
                            </code>{' '}
                ...
                <Col sm="12">
                    <Card title="Colors" code={dividerColors}>
                        <CardText>
                            Use class{' '}
                            <code>
                                .divider-[primary | secondary | success | danger
                                | warnings | info | dark]
                            </code>{' '}
                            with <code>.divider</code> to set text position.
                        </CardText>
                ...
                <Col sm="12">
                    <Card title="Style" code={dividerStyle}>
                        <CardText>
                            use class <code>.divider-[dotted | dashed]</code> to
                            change divider style. solid is default style you
