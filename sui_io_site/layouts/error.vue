        ...
        <div class="row align-items-center">
          <div class="col-lg-6">
            ...
            >
              ...
              <p>
                It looks like nothing found at this location. Try to navigate
                the menu or go to the home page.
              </p>
              <a href="/" class="sui-btn btn-fill-primary">Go Back</a>
            </div>
          </div>
        </div>
      </div>
...
<style lang="scss" scoped>
  ._sui-err {
    ...
    .sui-btn.btn-fill-primary {
      color: #fff !important;
      &:hover {
        color: #6fbcf0 !important;
      }
    }
  }
  .onepage-screen-area {
