                    ...
                    >
                        <div class="content">
                            ...
                            <ul class="mt--20 _copy">
                                <li>
                                    Lost key? No problem. Recover assets without
                                    an intermediary.
                                </li>
                                <li>
                                    Human readable signing requests: Know
                                    exactly what you're giving permission for.
                                </li>
                                <li>
                                    Send assets directly via email, SMS, DMs and
                                    any other channel.
                                </li>
                            </ul>
                        </div>
