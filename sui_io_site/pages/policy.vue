<template>
  <main class="container _sui-container-l">
    <div class="_sui-terms row">
      <div class="mt--150 text-center">
        <h1 class="title mb--40">Privacy Policy</h1>
        <!--<p class="last-update">Latest update: March 2022</p>-->
      </div>
      <section class="_sui-term-copy mt--40">
        <p>
          <strong>TERMS OF SERVICE</strong><br />
          <span><i>Last Updated: March 16, 2022</i></span>
        </p>
        <p>
          Mysten Labs, Inc., its subsidiaries and affiliates (collectively
          called <strong>“Mysten Labs”</strong>, <strong>“we,”</strong>
          <strong>“us,”</strong> and <strong>“our”</strong>) provide users with
          an interface which facilitates our interaction with the Protocol,
          allowing for activities such as the creation of NFTs, Blockchain
          games, DeFi apps, marketplaces, automated market makers, and wallets.
          This Privacy Policy is designed to help you understand how Mysten Labs
          collects, uses, and shares your personal information and to help you
          understand and exercise your privacy rights.
        </p>

        <ol class="_sui-list-3">
          <li>
          ...
          <li>
            <a href="#how-we-disclose-your-information"
              >HOW WE DISCLOSE YOUR INFORMATION</a
            >
          </li>
          <li>
            <a href="#your-privacy-choices-and-rights"
              >YOUR PRIVACY CHOICES AND RIGHTS</a
            >
          </li>
          <li>
            <a href="#security-of-your-information"
              >SECURITY OF YOUR INFORMATION</a
            >
          </li>
          <li>
          ...
          <li>
            <a href="#retention-of-personal-information"
              >RETENTION OF PERSONAL INFORMATION</a
            >
          </li>
          <li>
            <a href="#supplemental-notice-for-california-residents"
              >SUPPLEMENTAL NOTICE FOR CALIFORNIA RESIDENTS</a
            >
          </li>
          <li>
            <a href="#supplemental-notice-for-navada-residents"
              >SUPPLEMENTAL NOTICE FOR NEVADA RESIDENTS</a
            >
          </li>
          <li>
            <a href="#children's-information">CHILDREN’S INFORMATION</a>
          </li>
          <li>
            <a href="#third-party's-websites-applications"
              >THIRD-PARTY’S WEBSITES/APPLICATIONS</a
            >
          </li>
          <li>
            <a href="#supervisory-authority">SUPERVISORY AUTHORITY</a>
          </li>
          <li>
        ...
        <p id="scope">
          ...
          Mysten Labs, including on our websites (the “Site”), and other online
          and offline offerings. The Site, our services and our other online and
          offline offerings are collectively called the “Services.” For clarity,
          the Services do not include the Protocol or any other decentralized
          aspect of the Sui Blockchain that is not controlled by Mysten Labs due
          to the decentralized nature of the Sui Blockchain.
        </p>

        <p id="changes-to-our-privacy-policy">
          <strong>2. CHANGES TO OUR PRIVACY POLICY</strong><br />
        ...
        <p id="personal-information-we-collect">
          <strong>3. PERSONAL INFORMATION WE COLLECT</strong><br />
        ...
        <p>
          <strong>A. Information You Provide to Us Directly </strong><br />
          We may collect the following personal information that you provide to
          us.
        </p>
        <ul class="_sui-list-2">
          <li>
            <strong>Account Creation.</strong> We may collect information if you
            create an account with us, such as your name, username, email
            address, or password.
          </li>
          <li>
            <strong>Wallet and Transaction Information.</strong> In order to
            engage in transactions on the Services, you may need to provide us
            or our third-party payment processors with access to or information
            about your digital wallet. We will never ask you for or collect your
            private keys.
          </li>
          <li>
            <strong>Other Transactions. </strong> We may collect personal
            information and details associated with your activities on our
            Services, including to deliver you your rewards associated with your
            use of the Services.
          </li>
          <li>
            <strong>Your Communications with Us. </strong> We may collect
            personal information, such as email address when you request
            information about our Services, register for our newsletter or
            marketing promotions, request customer or technical support, apply
          ...
          <li>
            ...
            available through our interactive features (e.g., via the Mysten
            Labs community, commenting functionalities, forums, blogs, and
            social media pages). Any personal information you provide on the
            public sections of these features will be considered “public,”
            unless otherwise required by applicable law, and is not subject to
          ...
          <li>
            <strong>Sweepstakes, Giveaways or Contests. </strong> We may collect
            personal information you provide for any sweepstakes, giveaways or
            contests that we offer. In some jurisdictions, we are required to
            publicly share information of sweepstakes and contest winners.
          </li>
          <li>
            <strong>Conferences, Trade Shows, and Other Events. </strong>
            We may collect personal information from individuals when we attend
          ...
          <li>
            ...
            We may post job openings and opportunities on our Services. If you
            reply to one of these postings by submitting your application, CV
            and/or cover letter to us, we will collect and use this information
        ...
        <ul class="_sui-list-2">
          ...
          <li>
            <strong
              >Cookie Policy for Cookies, Pixel Tags/Web Beacons, and Other
              Technologies.</strong
            >
          ...
          <li>
            ...
            <ul class="_sui-list-2">
              ...
              <li>
                ...
                understand how individuals use our Services (see Analytics
                below);
              </li>
              <li>
              ...
              <li>
                ...
                e may use first party or third-party Technologies to deliver
          ...
          <li>
            See “<a href="#your-privacy-choices-and-rights"
              >Your Privacy Choices and Rights</a
            >” below to understand your choices regarding these Technologies.<br />

            <ul class="_sui-list-2">
              <li>
                <strong>Analytics. </strong>
                We may use our Technologies and other third-party tools to
                process analytics information on our Services. These
                technologies allow us to process usage data to better understand
                how our website and web-related Services are used, and to
                continually improve and personalize our Services. Some of our
                analytics partners include:
                <ul class="_sui-list-2">
                  <li>
                    <strong>Google Analytics. </strong>
                    For more information about how Google uses your data
                    (including for its own purposes, e.g., for profiling or
                    linking it to other data), please visit
                    <a
                      href="https://policies.google.com/privacy?hl=en-US"
                      target="_blank"
                      >Google Analytics’ Privacy Policy</a
                    >. To learn more about how to opt-out of Google Analytics’
                    use of your information, please
                    <a
                  ...
                  <li>
                    ...
                    <a
                      ...
                      target="_blank"
                      >LinkedIn Analytics’ Privacy Policy</a
                  ...
                  <li>
                    ...
                    For more information, please visit Facebook’s
                    <a
                      href="https://www.facebook.com/about/privacy/previous"
                      target="_blank"
                      >Data Policy</a
                    >. You can object to the collection of your data by Facebook
                    pixel, or to the use of your data for the purpose of
                    displaying Facebook ads by contacting the following address
                    while logged into your Facebook account:<a
                  ...
                  <li>
                    ...
                    Discord, Twitter, Instagram, TikTok, Youtube, and Telegram,
                    which might include widgets such as the “share this” button
                    or other interactive mini programs. These features may
                    collect your IP address and which page you are visiting on
                    our Services and may set a cookie to enable the feature to
                    function properly. Your interactions with these platforms
                    are governed by the privacy policy of the company providing
                    it.
                  </li>
                </ul>
              </li>
        ...
        <ul class="_sui-list-2">
          <li>
            <strong>Third-Party Sources. </strong> We may obtain information
            about you from other sources, including through third-party services
          ...
          <li>
            <strong>Referrals, Sharing and Other Features.</strong>
            ...
            service; third parties may also use these services to upload
            information about you. Our referral services may also allow you to
            forward or share certain content with a friend or colleague, such as
            an email inviting your friend to use our Services. Please only share
            with us contact information of people with whom you have a
            relationship (e.g., relative, friend, neighbor, or co-worker).
          </li>
        </ul>
        ...
        <p>
          ...
          you with our Services and perform our contract with you, such as:
        </p>
        <ul class="_sui-list-2">
        ...
        <p>
          ...
          permitted by applicable law. Some of the ways we may market to you
          include email campaigns, custom audiences advertising, and
          “interest-based” or “personalized advertising,” including through
          cross-device tracking. If you have any questions about our marketing
          practices or if you would like to opt out of the use of your personal
          information for marketing purposes, you may contact us at any time as
          set forth in
          <a href="#contact-us"> “Contact Us”</a> below.
        </p>
        <p>
          <strong>D. With Your Consent</strong><br />
        ...
        <p>
          <strong>E. Other Purposes</strong><br />
        ...
        <ul class="_sui-list-2">
          <li>
            ...
            decision making, you may contact us as set forth in
            <a href="#contact-us"> “Contact Us”</a> below.
          </li>
          <li>
        ...
        <p id="how-we-disclose-your-information">
          <strong>5. HOW WE DISCLOSE YOUR INFORMATION</strong><br />
        ...
        <p>
          <strong>A. Disclosures to Provide our Services</strong><br />
        ...
        <ul class="_sui-list-2">
          <li>
            ...
            will be conducted via the Sui Blockchain. Information about your
            transfers will be provided to the Sui Blockchain and may be
            accessible to third parties due to the public nature of the
            Blockchain. Because entries to the Sui Blockchain are, by their
            nature, public, and because it may be possible for someone to
            identify you through your pseudonymous, public wallet address using
            external sources of information, any transaction you enter onto the
            Sui Blockchain could possibly be used to identify you, or
            information about you.
          </li>
          <li>
            Other Users of the Services and Parties You Transact With. Some of
            your personal information may be visible to other users of the
          ...
          <li>
            ...
            third-party service providers who use that information to help us
            provide our Services. This includes service providers that provide
            us with IT support, hosting, customer service, and related services.
          </li>
          <li>
          ...
          <li>
            Affiliates. We may share your personal information with members of
            our corporate family.
          </li>
          <li>
            Other Users/Website Visitors. As described above in “<a
              href="#personal-information-we-collect"
              >Personal Information We Collect</a
            >,” our Services allow you to share your profile and/or User Content
            with other users or publicly, including to those who do not use our
            Services.
          </li>
          <li>
            Advertising Partners. We may share your personal information with
            third-party advertising partners. These third-party advertising
          ...
          <li>
            ...
            (“<strong>APIs</strong>”) and software development kits (“SDKs”) as
            part of the functionality of our Services. For more information
            about our use of APIs and SDKs, please contact us as set forth in
            <a href="#contact-us"> “Contact Us”</a> below.
          </li>
        </ul>
        <p>
          <strong>B. Disclosures to Protect Us or Others</strong><br />
        ...
        <p id="your-privacy-choices-and-rights">
          <strong
            >6. YOUR PRIVACY CHOICES AND RIGHTS<br />
            Your Privacy Choices.</strong
          >
        ...
        <ul class="_sui-list-2">
          <li>
            <strong>Email Communications.</strong><br />If you receive an
            ...
            that you will continue to receive transfer-related emails regarding
          ...
          <li>
            <strong>Text Messages.</strong><br />You may opt out of receiving
          ...
          <li>
            <strong>Mobile Devices.</strong><br />We may send you push
            notifications through our mobile application. You may opt out from
            receiving these push notifications by changing the settings on your
            mobile device. With your consent, we may also collect precise
            location-based information via our mobile application. You may opt
            out of this collection by changing the settings on your mobile
            device.
          </li>
          <li>
            <strong>“Do Not Track.”</strong><br />Do Not Track
            (“<strong>DNT</strong>”) is a privacy preference that users can set
          ...
          <li>
            <strong>Cookies and Interest-Based Advertising. </strong><br />You
            may stop or restrict the placement of Technologies on your device or
            ...
            the instructions for Android, iOS and others.
          </li>
        </ul>
        <p>
        ...
        <ul class="_sui-list-2">
          <li>
            ...
            whether we are processing your personal information; (ii) obtaining
            access to or a copy of your personal information; or (iii) receiving
            an electronic copy of personal information that you have provided to
            us, or asking us to send that information to another company (aka
          ...
          <li>
            ...
            information, including where the processing of your personal
            information is based on our legitimate interest or for direct
        ...
        <p>
          ...
          as set forth in
          <a href="#contact-us"> “Contact Us”</a> below. We will process such
          requests in accordance with applicable laws.
        </p>
        <p id="security-of-your-information">
        ...
        <p id="retention-of-personal-information">
          <strong>9. RETENTION OF PERSONAL INFORMATION</strong><br />
        ...
        <p id="supplemental-notice-for-california-residents">
          <strong>10. SUPPLEMENTAL NOTICE FOR CALIFORNIA RESIDENTS </strong
          ><br />
          ...
          Consumer Privacy Act of 2018 (“CCPA”). Mysten Labs does not believe it
          is subject to the CCPA. That said, Mysten Labs provides this
          supplemental notice for purpose of transparency. The CCPA provides
          California residents with the right to know what categories of
          personal information Mysten Labs has collected about them and whether
          Mysten Labs disclosed that personal information for a business purpose
          (e.g., to a service provider) in the preceding twelve months.
          California residents can find this information below:
        </p>
        <p class="gr-list">
          <strong
            >Category of Personal Information Collected by Mysten Labs</strong
          ><br />
          a) <strong>Identifiers</strong><br />
          A real name, postal address, unique personal identifier, online
        ...
        <p class="gr-list">
          ...
          other financial information. Personal Information does not include
          publicly available information that is lawfully made available to the
          general public from federal, state, or local government records. Note:
        ...
        <p class="gr-list">
          f)
          <strong>Professional or employment-related information</strong><br />
        ...
        <p class="gr-list">
          ...
          <strong
            ...
            profile about a consumer</strong
          ><br />
        ...
        <p class="gr-list">
          <strong
            ...
            for a Business Purpose </strong
          ><br />
          a)
        </p>

        <ul class="_sui-list-2 _list-2">
        ...
        <ul class="_sui-list-2 _list-2">
          <li>Service providers</li>
          <li>
            Third-party websites or applications (e.g., wallet providers;
        ...
        <p>
          ...
          information are set forth in “<a
            href="#personal-information-we-collect"
            >Personal Information we Collect</a
          >” and “<a href="#how-we-use-your-information"
            >How We Use of Your Information</a
          >” above, respectively.
        </p>
        <p>
          <strong>“Sales” of Personal Information under the CCPA</strong>. For
          purposes of the CCPA, Mysten Labs does not “sell” personal
        ...
        <p>
          ...
          request related to your personal information. To designate an
          authorized agent, please contact us as set forth in
          <a href="#contact-us"> “Contact Us”</a> below and provide written
        ...
        <p>
          ...
          associated with any personal information we have about you. If you are
          a California resident and would like to exercise any of your rights
          under the CCPA, please contact us as set forth in
          <a href="#contact-us"> “Contact Us”</a> below. We will process such
          requests in accordance with applicable laws.
        </p>
        <p>
          <strong>Refer-a-Friend and Similar Incentive Programs. </strong>As
          described above in “<a href="#how-we-use-your-information"
            >How We Use of Your Information</a
          >,” we may offer referral programs or other incentivized data
          collection programs. For example, we may offer incentives to you such
          as discounts or promotional items or credit in connection with these
          programs, wherein you provide your personal information in exchange
          for a reward, or provide personal information regarding your friends
          or colleagues (such as their email address) and receive rewards when
          they sign up to use our Services. (The referred party may also receive
          rewards for signing up via your referral.) These programs are entirely
          voluntary and allow us to grow our business and provide additional
          benefits to you. The value of your data to us depends on how you
          ultimately use our Services, whereas the value of the referred party’s
          data to us depends on whether the referred party ultimately becomes a
          user and uses our Services. Said value will be reflected in the
          incentive offered in connection with each program.
        </p>
        <p>
        ...
        <p>
          ...
          to have their posted content or information removed from the publicly
          viewable portions of the Services by contacting us directly as set
          forth in <a href="#contact-us"> “Contact Us”</a> below.
        </p>
        <p id="supplemental-notice-for-navada-residents">
          <strong>11. SUPPLEMENTAL NOTICE FOR NEVADA RESIDENTS </strong><br />If
          you are a resident of Nevada, you have the right to opt-out of the
          ...
          <a href="#contact-us"> “Contact Us”</a> below with the subject line
        ...
        <p id="children's-information">
          <strong>12. CHILDREN’S INFORMATION </strong><br />The Services are not
          directed to children under 13 (or other age as required by local law),
          and we do not knowingly collect personal information from children. If
          you learn that your child has provided us with personal information
          without your consent, you may contact us as set forth in
          <a href="#contact-us"> “Contact Us”</a>
          below. If we learn that we have collected a child’s personal
          information in violation of applicable law, we will promptly take
          steps to delete such information.
        </p>

        <p id="third-party's-websites-applications">
          <strong>13. THIRD-PARTY WEBSITES/APPLICATIONS </strong><br />The
          Services may contain links to other websites/applications (such as
        ...
        <p id="supervisory-authority">
          <strong>14. SUPERVISORY AUTHORITY </strong><br />If you are located in
          the European Economic Area, Switzerland, the United Kingdom, or
          Brazil, you have the right to lodge a complaint with a supervisory
          authority if you believe our processing of your personal information
          violates applicable law.
        </p>
        <p id="contact-us">
          <strong>15. CONTACT US </strong><br />
        ...
        <p>
          ...
          <a href="privacy@mystenlabs.com">privacy@mystenlabs.com</a><br />
          <a href="tel:1-408-384-8237">+1 (408) 384-8237</a>
        </p>
      </section>
    </div>
  </main>
...
<script lang="ts">
  ...
  export default class TermsPageComponent extends Vue {
    title!: string;
    head(): MetaInfo {
      return {
        title: "Sui - Privacy Policy",
      };
    }
  }
</script>
